<x-app-layout>
    <div class="mb-8 flex justify-between items-end">
        <div>
            ...
            <p class="text-gray-500">Create a new item for your food menu.</p>
        </div>
        ...
        <div class="p-8">
            <form method="POST" action="{{ route('admin.menu-items.store') }}">
                ...
                <div class="mb-6">
                    ...
                    <x-text-input id="name" class="block mt-1 w-full bg-gray-50 border-none rounded-xl py-3 px-4 focus:ring-2 focus:ring-blue-500 shadow-inner" type="text" name="name" :value="old('name')" required autofocus />
                ...
                <div class="grid grid-cols-2 gap-6 mb-6">
                    ...
                    <div>
                        ...
                        <x-text-input id="price" class="block mt-1 w-full bg-gray-50 border-none rounded-xl py-3 px-4 focus:ring-2 focus:ring-blue-500 shadow-inner" type="number" step="0.01" name="price" :value="old('price')" required />
                ...
                <div class="mb-6">
                    ...
                    <x-text-input id="stock" class="block mt-1 w-full bg-gray-50 border-none rounded-xl py-3 px-4 focus:ring-2 focus:ring-blue-500 shadow-inner" type="number" name="stock" :value="old('stock', 100)" required />
                    <x-input-error :messages="$errors->get('stock')" class="mt-2" />
                </div>

                <div class="mb-6">
                    <x-input-label for="image" :value="__('Image URL')" />
                    <x-text-input id="image" class="block mt-1 w-full bg-gray-50 border-none rounded-xl py-3 px-4 focus:ring-2 focus:ring-blue-500 shadow-inner" type="url" name="image" :value="old('image')" />
